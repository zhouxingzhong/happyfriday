<template>
  	<div>
        ...
        <div class="share_code">
            <header class="share_header">关注微信，获取答案。(私人微信，加人代号：前端000)</header>
        ...
        <div class>            
            <audio src="/static/audios/wudi.mp3" loop="loop"
            ...
            使用iframe授权自动播放
            chrome提高MEI指数（?）
            移动端用户将网站添加到home screen

            <iframe src = "/static/audios/wudi.mp3"  allow = "autoplay"/>
            -->
        </div>
  	</div>
</template>
...
export default {
    ...
    data(){
        return {
            ...
            scoreTipsArr:['你说，是不是把知识都还给小学老师了？','还不错，但还需要继续加油哦！','不要嘚瑟还有进步的空间！','智商离爆表只差一步了！','你也太聪明了！'],
        }
    },
